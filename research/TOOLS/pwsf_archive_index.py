...
running unchanged. New code should `from pwsf.archive_index import ...` instead.
"""
...
from pwsf.archive_index import *          # noqa: F401,F403
from pwsf import archive_index as _module
